...
class OneSignalService {
  constructor() {
    ...
    this.defaultConfig = {
      app_id: this.appId,
      target_channel: 'push',
      large_icon: 'https://www.rootmatrix.cloud	/logo.png',
      small_icon: 'https://www.rootmatrix.cloud	/logo',
      // url: 'https://www.rootmatrix.cloud	',
      chrome_web_icon: 'https://www.rootmatrix.cloud	/logo.png',
